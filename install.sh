...
sudo cp NR1-UI-Plugin/config/config.txt /boot/
...
sudo cp NR1-UI-Plugin/config/mpd.conf /etc/

sudo service mpd restart

echo "Cava1/Fifo Configuration..."

sudo cp NR1-UI-Plugin/config/cava1/config /home/volumio/.config/cava/
...
sudo cp NR1-UI-Plugin/config/cava2/config /home/volumio/.config/cava2/
